...
class ArrTest extends TestCase
{
    ...
    {
        $this->assertSame(true, Arr::accessible([123]));
        $this->assertSame(false, Arr::accessible(123));
    }
    ...
    public function testSet()
    {
        ...
        $this->assertSame([
            'products' => ['item' => ['price' => 200]],
            'goods'    => ['item' => ['price' => 200]],
        ], $array);
    }
    ...
    public function testCrossJoin()
    {
        ...
        // Square matrix
        $this->assertSame([[1, 'a'], [1, 'b'], [2, 'a'], [2, 'b']], Arr::crossJoin([1, 2], ['a', 'b']));
        // Rectangular matrix
        $this->assertSame([[1, 'a'], [1, 'b'], [1, 'c'], [2, 'a'], [2, 'b'], [2, 'c']], Arr::crossJoin([1, 2], [
            'a',
            'b',
            'c',
        ]));
